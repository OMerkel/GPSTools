...
* There is a more detailed set of information for the long distance trail https://omerkel.github.io/GPSTools/gpx/Odenwald/Odenwald-Schmetterling/[Odenwald Schmetterling].
